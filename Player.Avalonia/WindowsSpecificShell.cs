...
using PlayerResources = Resources.Resources;

namespace DJPad.Experimental;

internal sealed class WindowsSpecificShell
{
    ...
    public void SetOverlayIcon(IntPtr windowHandle, IPlaylistItem? item, bool playing)
    {
        ...
        var artwork = item.SynchronousArt ?? PlayerResources.Unknown;
        using var coverArt = artwork.Overlay(
            playing ? PlayerResources.Player_Play_Small : PlayerResources.Player_Pause_Small,
